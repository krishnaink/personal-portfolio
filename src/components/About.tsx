...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-slate-100 via-blue-50 to-slate-200">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              As a Computer Science student at George Mason University, I've developed expertise in 
              full-stack development, machine learning, and artificial intelligence. My experience 
              spans from working as a software engineering intern at Citi to serving as an undergraduate 
              teaching assistant helping over 200 students.
            </p>
            <p className="text-gray-600 leading-relaxed">
              I'm particularly passionate about creating efficient, scalable solutions 
              and have experience in everything from real-time data visualization to AI-powered 
              applications. I hold AWS Cloud Practitioner certification and Stanford Machine Learning 
              Specialization, demonstrating my commitment to continuous learning.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Java', 'Python', 'C', 'JavaScript', 'HTML/CSS', 'SQL'].map((skill) => (
                  <span key={skill} className="bg-white px-3 py-1 rounded-full text-sm text-gray-700 shadow-sm border border-blue-300 hover:bg-blue-50 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
